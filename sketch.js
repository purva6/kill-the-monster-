...
function setup() {
  ...
  block3 = new Block(300,350,30,40);
  block4 = new Block(300,350,30,40);
  block5 = new Block(300,350,30,40);
  block6 = new Block(300,350,30,40);
  block7 = new Block(300,350,30,40);
  block8 = new Block(400,350,30,40);
  block9 = new Block(400,315,30,40);
  block10 = new Block(400,315,30,40);
  block11 = new Block(400,315,30,40);
  block12 = new Block(400,315,30,40);
  block13 = new Block(400,315,30,40);
  block14 = new Block(400,315,30,40);
